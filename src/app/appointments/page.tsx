  ...
  const handleBookAppointment = async () => {
    ...
    bookAppointmentMutation.mutate(
      ...
      },
      {
        onSuccess: async (appointment) => {
          ...
          try {
            ...
            if (emailResponse.ok) {
              ...
              console.error("Failed to sent confirmation email");
              toast.error(
                "Appointment Book, but confirmation email failed to sent",
              );
            }
          } catch (error) {
        ...
        onError: (error) => {
          toast.error("Failed to book this appointment");
          console.error("Failed to book this appointment", error);
        },
      },
    );
  };
